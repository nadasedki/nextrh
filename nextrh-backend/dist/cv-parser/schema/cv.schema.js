...
exports.CvSchema = exports.ProjectsFallbackSchema = exports.EducationFallbackSchema = exports.CertificationsFallbackSchema = exports.ExperiencesFallbackSchema = void 0;
...
exports.CvSchema = zod_1.z.object({
    ...
    skills: zod_1.z.array(zod_1.z.string()).describe("Le tableau des compétences techniques clés S'il n'existe aucun titre de ce type dans le document, retourne obligatoirement un tableau vide []."),
    certifications: zod_1.z.array(zod_1.z.object({
