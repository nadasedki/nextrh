...
exports.TeamsModule = TeamsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([team_entity_1.Team, user_entity_1.User]), (0, common_1.forwardRef)(() => auth_module_1.AuthModule),
            (0, common_1.forwardRef)(() => users_module_1.UsersModule),],
        providers: [teams_service_1.TeamsService],
        controllers: [teams_controller_1.TeamsController],
        exports: [typeorm_1.TypeOrmModule, teams_service_1.TeamsService],
    })
], TeamsModule);
