...
export const CvSchema = z.object({
  ...
  skills: z.array(z.string()).describe("Le tableau des compétences techniques clés S'il n'existe aucun titre de ce type dans le document, retourne obligatoirement un tableau vide []."),
