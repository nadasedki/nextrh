...
async function main() {
    ...
    try {
        ...
        const identityInput = blocks.header || fullText;
    ...
    try {
        ...
        const result = await callLLMWithLangChain(expInput, "Corporate Roles", ExperienceSchema, expInstructions);
    ...
    try {
        ...
        const result = await callLLMWithLangChain(projectInput, "Tabular Client Projects", ProjectSchema, projectInstructions);
    ...
    try {
        ...
        const result = await callLLMWithLangChain(eduInput, "Education Background", EducationSchema, eduInstructions);
    ...
    `;
        const result = await callLLMWithLangChain(certInput, "Professional Certifications", CertificationSchema, certInstructions);
    ...
    `;
        const result = await callLLMWithLangChain(skillsInput, "Technical Skills Inventory", SkillsSchema, skillsInstructions);
...
//# sourceMappingURL=test-pllms.js.map